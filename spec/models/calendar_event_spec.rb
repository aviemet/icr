...
RSpec.describe CalendarEvent do
  ...
  describe "Associations" do
    ...
    it { is_expected.to belong_to(:recurring_pattern).optional }
  ...
  describe "Scopes" do
    ...
    before do
      @event1 = create(:calendar_event, starts_at: 1.day.ago, ends_at: 1.hour.ago)
      @event2 = create(:calendar_event, starts_at: 3.days.ago, ends_at: 2.days.ago)
      @event3 = create(:calendar_event, starts_at: 7.days.ago, ends_at: 6.days.ago)
      @event4 = create(:calendar_event, starts_at: 1.hour.from_now, ends_at: 2.hours.from_now)
      @event5 = create(:calendar_event, starts_at: 2.days.from_now, ends_at: 3.days.from_now)
      @event6 = create(:calendar_event, starts_at: 1.week.from_now, ends_at: 1.week.from_now + 1.day)
    end
