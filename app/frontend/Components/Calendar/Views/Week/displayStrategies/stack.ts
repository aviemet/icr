...
const compareWeekStack = <T extends CalendarGenerics>(
...
export const weekStackStrategy: DisplayStrategyFunction<CalendarGenerics> = <T extends CalendarGenerics>(
	event: T["Event"],
