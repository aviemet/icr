...
import { EventResources, BaseCalendarEvent, CalendarClickTarget } from "@/components/Calendar"
...
export interface PopoverContentMap<TEventResources extends EventResources> {
	event?: (event: BaseCalendarEvent<TEventResources>, localizer: CalendarLocalizer) => React.ReactNode
	background?: (context: { date: Date, time?: Date, resourceId?: string | number }, localizer: CalendarLocalizer) => React.ReactNode
}

interface CalendarPopoverProps<TEventResources extends EventResources> {
	target: CalendarClickTarget<TEventResources>
	position: { top: number, left: number }
	className: string
	popoverContent?: Partial<PopoverContentMap<TEventResources>>
	localizer: CalendarLocalizer
	popoverRef: React.RefObject<HTMLDivElement>
}

export function CalendarPopover<TEventResources extends EventResources>({
	target,
	position,
	className,
	popoverContent,
	localizer,
	popoverRef,
}: CalendarPopoverProps<TEventResources>) {
